...
import { ArrowLeft, TrendingUp, TrendingDown, BarChart3, Cpu, Info, Sparkles } from 'lucide-react';
...
const StockDetailView = ({ stock, onBack }) => {
  ...
  const tabs = [
    ...
    { id: 'chat', label: 'Ask AI', icon: <Sparkles size={16} /> },
  ];
